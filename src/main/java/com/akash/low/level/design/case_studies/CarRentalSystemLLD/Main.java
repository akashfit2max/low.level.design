...
import com.akash.low.level.design.case_studies.CarRentalSystemLLD.models.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        Location location = new Location("Ashish A N", 560066, "Banglore", "Karnataka", "India");
        ...
        Reservation reservation = store.creatReservation(storeVehicles.get(0), users.get(0));
        ...
        System.out.println("Reservation completed" + reservation.toString());
