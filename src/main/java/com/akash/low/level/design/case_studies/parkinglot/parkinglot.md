...
#### parking lot CURD APIs

* `creating a parking lot` - `POST` - `/parking-lot` - `creat parking lot dto` - `return parkinfg lot respose`

```mermaid
classDiagram
    class CreatParkingLotRequest {
        -String name
        -String address
        -int numberOfFloors
...
classDiagram
    ...
    ParkingLot "1" --* "1" DisplayeBoard: exitGates
    ParkingFloor "1" --* "*" ParkingSpot
    ParkingFloor "1" --* "*" PaymentCounter
    ParkingFloor "1" --* "*" DisplayeBoard
